...
(lib.LD_10_4D_Big = function() {
	this.initialize(img.LD_10_4D_Big);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.LD_10_6D_Big = function() {
	this.initialize(img.LD_10_6D_Big);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.LD_10_6H_Big = function() {
	this.initialize(img.LD_10_6H_Big);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.LD_10_9C_Big = function() {
	this.initialize(img.LD_10_9C_Big);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.LD_10_JD_Big = function() {
	this.initialize(img.LD_10_JD_Big);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.LD_10_QS_Big = function() {
	this.initialize(img.LD_10_QS_Big);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{"stop_1":0,"stop_2":1,"stop_3":2,"stop_4":3,"stop_5":4,"stop_6":5,"dealer_1":6,"dealer_2":7,"dealer_3":8,"dealer_4":9,"dealer_5":10});
	...
	// letter
	this.instance = new lib.LD_10_JD_Big();
	this.instance.setTransform(11,16,0.9034,0.9034);

	this.instance_1 = new lib.LD_10_6H_Big();
	...
	this.instance_4 = new lib.Winner_J();
	this.instance_4.setTransform(11,16,1.1082,1.1081);

	this.instance_5 = new lib.Loser_8();
	this.instance_5.setTransform(11,16,1.1082,1.1081);

	this.instance_6 = new lib.Loser_Q();
	this.instance_6.setTransform(11,16,1.1081,1.1085);

	this.instance_7 = new lib.LD_10_QS_Big();
	this.instance_7.setTransform(11,16,0.9071,0.9072);

	this.instance_8 = new lib.LD_10_4D_Big();
	this.instance_8.setTransform(11,16,0.9072,0.8984);

	this.instance_9 = new lib.LD_10_9C_Big();
	this.instance_9.setTransform(11,16,0.9072,0.9072);

	this.instance_10 = new lib.LD_10_6D_Big();
...
// stage content:
(lib.CardFlipActivity_C_10_LD = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	manifest: [
		...
		{src:"./images/LD_10_4D_Big.png", id:"LD_10_4D_Big"},
		{src:"./images/LD_10_6D_Big.png", id:"LD_10_6D_Big"},
		{src:"./images/LD_10_6H_Big.png", id:"LD_10_6H_Big"},
		{src:"./images/LD_10_9C_Big.png", id:"LD_10_9C_Big"},
		{src:"./images/LD_10_JD_Big.png", id:"LD_10_JD_Big"},
		{src:"./images/LD_10_QS_Big.png", id:"LD_10_QS_Big"},
