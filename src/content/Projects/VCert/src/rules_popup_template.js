...
console.log(vcertData,vcertData[currentTrack])
		...
		<div class="modal-dialog" style="overflow-y: initial !important">
			...
			<div class="red-dot"></div>RULES<div class="red-dot"></div>
				...
				<div class="modal-body modal-popout-bg">
					...
					VCERT Performance+ Challenge ` + challengeNumber +`
					</div>
					<div class='row'>
						<div class='col'>
							<div class="center-img"><img src="images/challenge/Complete_Icon.png"></div>
							<div class="block-container" style=" display: block">
								<div class="right emphasis-bold" style="text-transform: uppercase;">
									` + vcertData[currentTrack][challengeNumber].rules.info_1 + `
								</div>
							</div>
						</div>
						<div class='col'>
							...
							<div class="block-container" style=" display: block">
								<div class="right emphasis-bold" style="">
									MINIMUM PASSING<br>
									SCORE = ` + vcertData[currentTrack][challengeNumber].minScore +` PERCENT
								</div><img class="more-info-img" onclick="moreInfo(2)" src="images/challenge/More_Icon_UP.png">
								<div class="info-box more-info-2">
									<div class="info-box-header"><img class='x-btn' src="images/challenge/Exit_UP.png"></div>` + vcertData[currentTrack][challengeNumber].rules.info_2 +`
								</div>
							</div>
						</div>
					</div>
						...
						<div class='col'>
							...
							<div class="block-container" style=" display: block">
								...
								<div class="info-box more-info-3">
									<div class="info-box-header"><img class='x-btn' src="images/challenge/Exit_UP.png"></div>` + vcertData[currentTrack][challengeNumber].rules.info_3 +`
								</div>
							</div>
						</div>
						<div class='col'>
							...
							<div class="block-container" style=" display: block">
								...
								<div class="info-box more-info-4">
									<div class="info-box-header"><img class='x-btn' src="images/challenge/Exit_UP.png"></div>` + vcertData[currentTrack][challengeNumber].rules.info_4 +`
								</div>
							</div>
						</div>
					</div>
