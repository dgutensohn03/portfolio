  ...
  if (user) {
    ...
    firebase.database().ref('/' + dbLocation + '/' + userId).once('value').then(function (snapshot) {
      ...
      if (hasAdminRights == true) {
        ...
        var newEntry = function newEntry(TeamList) {
        ...
        var newHead1 = function newHead1(giveTo, para1, para2, para3, para4) {
        ...
        var newBody1 = function newBody1(giveTo, para1, para2, para3, para4, FLAG) {
        ...
        var gatherData = function gatherData(TeamList) {
          ...
          userDatabaseLocation.orderByValue().on("value", function (snapshot) {
            ...
            snapshot.forEach(function (data) {
              userCount++; //console.log(userCount + ': User' + ' - ' + data.key)
