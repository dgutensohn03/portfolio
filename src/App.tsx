...
const projects: Project[] = [
  {
    ...
    fullDescription: (
      <div className="text-gray-700 space-y-4">
        <p>
          <strong>VCERT Performance+</strong> is a dynamic, web-based learning
          platform designed to enhance the skills of VCERT Certified Sellers
          through interactive challenges and real-time performance tracking.
        </p>
...
const skills: Skill[] = [
  {
    ...
    experience: 90,
    links: [
      { label: 'Official Docs', href: 'https://reactjs.org/' },
      {
        label: 'VCert Project',
  ...
  },
  {
    ...
    icon: '🟢',
    experience: 85,
    links: [{ label: 'Official Docs', href: 'https://nodejs.org/' }],
  },
  {
    name: 'SCORM/xAPI',
    ...
    experience: 95,
    links: [
      { label: 'xAPI Reference', href: 'https://xapi.com/' },
      { label: 'SCORM Guide', href: 'https://scorm.com/' },
    ],
  },
  {
    name: 'Docker',
  ...
  },
  {
    name: 'Adobe Suite',
    description:
      'Photoshop, Illustrator, Animate CC, After Effects, Premiere Pro.',
    level: 'Advanced',
    icon: '🎨',
    experience: 80,
  },
    ...
    <div>
      ...
      <div className="min-h-screen p-6 md:p-12 max-w-7xl mx-auto">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-6 border-b pb-2 theme-text">
            Experience
          </h2>
        ...
        <section className="mb-12 bg-alt shadow rounded-lg p-6">
          <h2 className="text-2xl font-semibold mb-4 border-b pb-2 theme-text">
            Education
          </h2>
