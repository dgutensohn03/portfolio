...
QUnit.test("newEntry should create a new table with correct class names and content", function (assert) {
  ...
  var appendChildStub = sinon.stub(document.getElementById("teamList_Body1"), "appendChild"); // Act

  newEntry(TeamList, matchedArray); // Assert
  ...
  assert.equal(appendChildStub.getCall(1).args[0].outerHTML, expectedTable2, "Second table should have correct class names and content"); // Restore stubs
