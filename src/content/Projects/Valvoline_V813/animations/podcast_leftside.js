...
lib.ssMetadata = [
		{name:"podcast_leftside_atlas_", frames: [[0,0,139,170],[141,0,63,4],[0,180,256,5],[0,172,256,6],[206,0,13,14]]}
];
...
(lib.Group_0 = function() {
	this.initialize(ss["podcast_leftside_atlas_"]);
	this.gotoAndStop(0);
...
(lib.animation = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var podcastPagesVar = lectoraWindow.Var_podCastPages.getValue();
		var podcastPages = parseInt(podcastPagesVar);
	...
	this.playbar.setTransform(380,486.5,1,1,0,0,0,128,2.5);
...
p.nominalBounds = new cjs.Rectangle(735,599.5,468.20000000000005,-106.5);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/podcast_leftside_atlas_.png", id:"podcast_leftside_atlas_"}
	],
	preloads: []
};
