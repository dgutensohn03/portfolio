...
function hasWeeksPassed(startDate, numberOfWeeks) {
  ...
  // Create a new date by adding the number of days to the start date
...
// Example usage
var startDate = snapshot.child("ClassCompletion" + thisClass).val();; // Start date in YYYY-MM-DD format
