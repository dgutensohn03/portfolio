...
(lib._10DiamondsBig = function() {
	this.initialize(img._10DiamondsBig);
...
(lib.Dealer_2 = function() {
	this.initialize(img.Dealer_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,98,136);


(lib.Dealer_8D = function() {
	this.initialize(img.Dealer_8D);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,99,136);
...
(lib.Loser_8 = function() {
	this.initialize(img.Loser_8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,194,267);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{"stop_1":0,"stop_2":1,"stop_3":2,"stop_4":3,"stop_5":4,"stop_6":5,"dealer_1":6,"dealer_2":7,"dealer_3":8,"dealer_4":9,"dealer_5":10});
	...
	// letter
	this.instance = new lib.Player_Winner_J();
	this.instance.setTransform(11,16,1.1082,1.1068);

	this.instance_1 = new lib.Loser_4();
	this.instance_1.setTransform(11,16,1.1082,1.1082);

	this.instance_2 = new lib.Dealer_8D();
	this.instance_2.setTransform(11,16,2.194,2.1727);

	this.instance_3 = new lib.Dealer_10C();
	this.instance_3.setTransform(11,16,2.1715,2.1727);

	this.instance_4 = new lib._10DiamondsBig();
	this.instance_4.setTransform(11,16,1.1082,1.1082);

	this.instance_5 = new lib.Winner_Q();
	this.instance_5.setTransform(11,16,1.114,1.1146);

	this.instance_6 = new lib.Loser_J();
	this.instance_6.setTransform(11,16,1.1082,1.1082);

	this.instance_7 = new lib.Dealer_10H();
	this.instance_7.setTransform(11,16,2.1826,2.1826);

	this.instance_8 = new lib.Dealer_2();
	this.instance_8.setTransform(11,16,2.1939,2.1728);

	this.instance_9 = new lib.Loser_8();
	this.instance_9.setTransform(11,16,1.1082,1.1082);

	this.instance_10 = new lib.Dealer_8H();
	this.instance_10.setTransform(11,16,2.1938,2.1935);
...
// stage content:
(lib.CardFlipActivity_C3 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"./images/_10DiamondsBig.png", id:"_10DiamondsBig"},
		...
		{src:"./images/Dealer_2.png", id:"Dealer_2"},
		{src:"./images/Dealer_8D.png", id:"Dealer_8D"},
		{src:"./images/Dealer_8H.png", id:"Dealer_8H"},
		{src:"./images/Loser_4.png", id:"Loser_4"},
		{src:"./images/Loser_8.png", id:"Loser_8"},
