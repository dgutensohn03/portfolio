...
(lib.Loser_A = function() {
	this.initialize(img.Loser_A);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,194,267);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{"stop_1":0,"stop_2":1,"stop_3":2,"stop_4":3,"stop_5":4,"stop_6":5,"dealer_1":6,"dealer_2":7,"dealer_3":8,"dealer_4":9,"dealer_5":10});
	...
	this.instance_2 = new lib.Loser_A();
	this.instance_2.setTransform(11,16,1.1082,1.1082);

	this.instance_3 = new lib.Loser_8();
	this.instance_3.setTransform(11,16,1.1082,1.1082);

	this.instance_4 = new lib.Winner_Q();
	this.instance_4.setTransform(11,16,1.1082,1.1082);

	this.instance_5 = new lib.Player_Winner_Q1();
	this.instance_5.setTransform(11,16,1.1082,1.1082);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_9}]},1).wait(1));
...
// stage content:
(lib.CardFlipActivity_C8 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	manifest: [
		...
		{src:"./images/Loser_A.png", id:"Loser_A"},
