...
(lib.VPS_5_4DBig = function() {
	this.initialize(img.VPS_5_4DBig);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.VPS_5_8SBig = function() {
	this.initialize(img.VPS_5_8SBig);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.VPS_5_9CBig = function() {
	this.initialize(img.VPS_5_9CBig);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.VPS_5_9DBig = function() {
	this.initialize(img.VPS_5_9DBig);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.VPS_5_JHBig = function() {
	this.initialize(img.VPS_5_JHBig);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.VPS_5_JSBig = function() {
	this.initialize(img.VPS_5_JSBig);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.VPS_5_QDBigV2 = function() {
	this.initialize(img.VPS_5_QDBigV2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.VPS_5_QHBig = function() {
	this.initialize(img.VPS_5_QHBig);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.VPS_5_QSBig = function() {
	this.initialize(img.VPS_5_QSBig);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{"stop_1":0,"stop_2":1,"stop_3":2,"stop_4":3,"stop_5":4,"stop_6":5,"dealer_1":6,"dealer_2":7,"dealer_3":8,"dealer_4":9,"dealer_5":10});
	...
	// letter
	this.instance = new lib.VPS_5_QHBig();
	this.instance.setTransform(11,16,0.9072,0.9071);

	this.instance_1 = new lib.VPS_5_QSBig();
	this.instance_1.setTransform(11,16,0.9072,0.9072);

	this.instance_2 = new lib.VPS_3_Big10H();
	this.instance_2.setTransform(11,16,0.9072,0.9072);

	this.instance_3 = new lib.VPS_3_Big3H();
	this.instance_3.setTransform(11,16,0.9072,0.9072);

	this.instance_4 = new lib.VPS_5_QDBigV2();
	this.instance_4.setTransform(11,16,0.9072,0.9072);

	this.instance_5 = new lib.VPS_5_8SBig();
	this.instance_5.setTransform(11,16,0.9072,0.9072);

	this.instance_6 = new lib.VPS_5_9CBig();
	this.instance_6.setTransform(11,16,0.9071,0.9072);

	this.instance_7 = new lib.VPS_5_9DBig();
	this.instance_7.setTransform(11,16,0.9071,0.9072);

	this.instance_8 = new lib.VPS_5_4DBig();
	this.instance_8.setTransform(11,16,0.9072,0.8984);

	this.instance_9 = new lib.VPS_5_JSBig();
	this.instance_9.setTransform(11,16,0.9072,0.9072);

	this.instance_10 = new lib.VPS_5_JHBig();
...
// stage content:
(lib.CardFlipActivity_C_5_VPS = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	manifest: [
		...
		{src:"./images/VPS_5_4DBig.png", id:"VPS_5_4DBig"},
		{src:"./images/VPS_5_8SBig.png", id:"VPS_5_8SBig"},
		{src:"./images/VPS_5_9CBig.png", id:"VPS_5_9CBig"},
		{src:"./images/VPS_5_9DBig.png", id:"VPS_5_9DBig"},
		{src:"./images/VPS_5_JHBig.png", id:"VPS_5_JHBig"},
		{src:"./images/VPS_5_JSBig.png", id:"VPS_5_JSBig"},
		{src:"./images/VPS_5_QDBigV2.png", id:"VPS_5_QDBigV2"},
		{src:"./images/VPS_5_QHBig.png", id:"VPS_5_QHBig"},
		{src:"./images/VPS_5_QSBig.png", id:"VPS_5_QSBig"},
