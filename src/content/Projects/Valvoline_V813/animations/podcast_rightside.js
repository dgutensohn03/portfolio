...
lib.ssMetadata = [
		{name:"podcast_rightside_atlas_", frames: [[0,0,139,170],[141,0,63,4],[0,180,256,5],[0,172,256,6],[206,0,13,14]]}
];
...
(lib.Group_0 = function() {
	this.initialize(ss["podcast_rightside_atlas_"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.Group, new cjs.Rectangle(-5,0,139,170), null);
...
// stage content:
(lib.animationrightside = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		/*		var lectoraWindow;
				...
				if (window.top[1].name != "main") {
					...
					lectoraWindow = window.top[1][0];
					}
			
			console.log('activity level: ' + lectoraWindow)*/
		...
		var podcastPages = parseInt(lectoraWindow.Var_podCastPages.getValue());
		var podcastLocation = lectoraWindow.Var_podCastPosition.getValue();
		var podcastStep = lectoraWindow.Var_podCastPosition.getValue();
				console.log(podcastPages)
				if (podcastLocation < podcastPages) {
					podcastStep++;
					lectoraWindow.Var_podCastStep.set(podcastStep)
					podcastLocation++;
					lectoraWindow.Var_podCastPosition.set(podcastLocation)
	...
	this.instance.setTransform(1133.7,363.45,1,1,0,0,0,64.5,85);
	...
	this.playbar.setTransform(790,486.5,1,1,0,0,0,128,2.5);
...
p.nominalBounds = new cjs.Rectangle(1145,599.5,58.200000000000045,-106.5);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/podcast_rightside_atlas_.png", id:"podcast_rightside_atlas_"}
	],
	preloads: []
};
