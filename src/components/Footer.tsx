...
const Footer = () => {
  ...
  return (
    <footer
      className="
        w-full p-4 
        bg-[var(--color-bg)] text-[var(--color-theme)]
        flex justify-center md:justify-end
        border-t border-[var(--color-theme)]
        
        /* responsive positioning */
        relative md:fixed md:bottom-0 md:right-0
      "
    >
      <div className="flex flex-wrap justify-center items-center gap-6">
        {contacts.map((contact) => (
          <a
            ...
            className="group relative flex flex-col items-center justify-center w-12 h-12 md:w-16 md:h-16 rounded-full border shadow-lg transform transition-transform duration-300 hover:scale-110"
            style={{
          ...
          >
            <div className="text-2xl md:text-3xl">{contact.icon}</div>
            <span
        ...
        {/* Resume icon */}
        <div
          className="group relative flex flex-col items-center justify-center w-12 h-12 md:w-16 md:h-16 rounded-full border shadow-lg transform transition-transform duration-300 hover:scale-110 cursor-pointer"
          style={{
            color: 'var(--color-theme)',
            borderColor: 'var(--color-theme)',
            backgroundColor: 'var(--color-bg)',
