...
(lib.LD_9_10CWin = function() {
	this.initialize(img.LD_9_10CWin);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,215,296);


(lib.LD_9_10D_Big = function() {
	this.initialize(img.LD_9_10D_Big);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.LD_9_10H_Big = function() {
	this.initialize(img.LD_9_10H_Big);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.LD_9_3H_Big = function() {
	this.initialize(img.LD_9_3H_Big);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.LD_9_4D_Big = function() {
	this.initialize(img.LD_9_4D_Big);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.LD_9_6S_Big = function() {
	this.initialize(img.LD_9_6S_Big);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.LD_9_8S_Big_Lose = function() {
	this.initialize(img.LD_9_8S_Big_Lose);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.LD_9_9C_Big = function() {
	this.initialize(img.LD_9_9C_Big);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.LD_9_9D_Big = function() {
	this.initialize(img.LD_9_9D_Big);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.LD_9_JH_Big = function() {
	this.initialize(img.LD_9_JH_Big);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);


(lib.LD_9_JS_Big = function() {
	this.initialize(img.LD_9_JS_Big);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,237,327);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{"stop_1":0,"stop_2":1,"stop_3":2,"stop_4":3,"stop_5":4,"stop_6":5,"dealer_1":6,"dealer_2":7,"dealer_3":8,"dealer_4":9,"dealer_5":10});
	...
	// letter
	this.instance = new lib.LD_9_10H_Big();
	this.instance.setTransform(11,16,0.9034,0.9034);

	this.instance_1 = new lib.LD_9_6S_Big();
	this.instance_1.setTransform(11,16,0.9071,0.907);

	this.instance_2 = new lib.LD_9_10D_Big();
	this.instance_2.setTransform(11,16,0.9072,0.9072);

	this.instance_3 = new lib.LD_9_3H_Big();
	this.instance_3.setTransform(11,16,0.9072,0.9072);

	this.instance_4 = new lib.LD_9_10CWin();
	this.instance_4.setTransform(11,16,1.0001,0.9998);

	this.instance_5 = new lib.LD_9_8S_Big_Lose();
	this.instance_5.setTransform(11,16,0.9072,0.9071);

	this.instance_6 = new lib.LD_9_9C_Big();
	this.instance_6.setTransform(11,16,0.9072,0.9075);

	this.instance_7 = new lib.LD_9_9D_Big();
	this.instance_7.setTransform(11,16,0.9071,0.9072);

	this.instance_8 = new lib.LD_9_4D_Big();
	this.instance_8.setTransform(11,16,0.9072,0.8984);

	this.instance_9 = new lib.LD_9_JS_Big();
	this.instance_9.setTransform(11,16,0.9072,0.9072);

	this.instance_10 = new lib.LD_9_JH_Big();
...
// stage content:
(lib.CardFlipActivity_C_9_LD = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	manifest: [
		...
		{src:"./images/LD_9_10CWin.png", id:"LD_9_10CWin"},
		{src:"./images/LD_9_10D_Big.png", id:"LD_9_10D_Big"},
		{src:"./images/LD_9_10H_Big.png", id:"LD_9_10H_Big"},
		{src:"./images/LD_9_3H_Big.png", id:"LD_9_3H_Big"},
		{src:"./images/LD_9_4D_Big.png", id:"LD_9_4D_Big"},
		{src:"./images/LD_9_6S_Big.png", id:"LD_9_6S_Big"},
		{src:"./images/LD_9_8S_Big_Lose.png", id:"LD_9_8S_Big_Lose"},
		{src:"./images/LD_9_9C_Big.png", id:"LD_9_9C_Big"},
		{src:"./images/LD_9_9D_Big.png", id:"LD_9_9D_Big"},
		{src:"./images/LD_9_JH_Big.png", id:"LD_9_JH_Big"},
		{src:"./images/LD_9_JS_Big.png", id:"LD_9_JS_Big"},
