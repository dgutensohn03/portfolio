...
! function(n) {
    ...
    t.prototype.toggle = function() {
        var n = this.$element.parent('[data-toggle="buttons-radio"]');
...
! function(n) {
    ...
    t.prototype = {
        ...
        pause: function(n) {
            return n || (this.paused = !0), clearInterval(this.interval), this.interval = null, this
        },
        next: function() {
        ...
        slide: function(t, i) {
            var u = this.$element.find(".active"),
                r = i || u[t](),
                o = this.interval,
                f = t == "next" ? "left" : "right",
                h = t == "next" ? "first" : "last",
    ...
    n.fn.carousel = function(i) {
        return this.each(function() {
            ...
            typeof i == "number" ? r.to(i) : typeof i == "string" || (i = u.slide) ? r[i]() : u.interval && r.cycle()
        })
    };
...
! function(n) {
    ...
    t.prototype = {
        ...
        show: function() {
            ...
            if (!this.transitioning) {
                ...
                this.$element[i](this.$element[0][u])
            }
        },
        hide: function() {
            var t;
    ...
    n(function() {
        n("body").on("click.collapse.data-api", "[data-toggle=collapse]", function(t) {
            var i = n(this),
                r, u = i.attr("data-target") || t.preventDefault() || (r = i.attr("href")) && r.replace(/.*(?=#[^\s]+$)/, ""),
                f = n(u).data("collapse") ? "toggle" : i.data();
            n(u).collapse(f)
        })
    })
}(window.jQuery);
! function(n) {
    ...
    t.prototype = {
        ...
        toggle: function() {
            var u = n(this),
                i, t, f;
            if (!u.is(".disabled, :disabled")) return t = u.attr("data-target"), t || (t = u.attr("href"), t = t && t.replace(/.*(?=#[^\s]*$)/, "")), i = n(t), i.length || (i = u.parent()), f = i.hasClass("open"), r(), f || i.toggleClass("open"), !1
        }
    };
    ...
    n(function() {
        n("html").on("click.dropdown.data-api", r);
        n("body").on("click.dropdown", ".dropdown form", function(n) {
            n.stopPropagation()
...
! function(n) {
    ...
    function r(t) {
        var f = this,
            ...
            i;
        this.isShown && this.options.backdrop ? (i = n.support.transition && r, this.$backdrop = n('<div class="modal-backdrop ' + r + '" />').appendTo(document.body), this.options.backdrop != "static" && this.$backdrop.click(n.proxy(this.hide, this)), i && this.$backdrop[0].offsetWidth, this.$backdrop.addClass("in"), i ? this.$backdrop.one(n.support.transition.end, t) : t()) : !this.isShown && this.$backdrop ? (this.$backdrop.removeClass("in"), n.support.transition && this.$element.hasClass("fade") ? this.$backdrop.one(n.support.transition.end, n.proxy(u, this)) : u.call(this)) : t && t()
    }
    ...
    function f() {
        var t = this;
        if (this.isShown && this.options.keyboard) n(document).on("keyup.dismiss.modal", function(n) {
            n.which == 27 && t.hide()
        });
        else this.isShown || n(document).off("keyup.dismiss.modal")
    }
    var t = function(t, i) {
        this.options = i;
    ...
    t.prototype = {
        ...
        show: function() {
            var t = this,
                i = n.Event("show");
            (this.$element.trigger(i), this.isShown || i.isDefaultPrevented()) || (n("body").addClass("modal-open"), this.isShown = !0, f.call(this), r.call(this, function() {
        ...
        hide: function(t) {
            t && t.preventDefault();
            var r = this;
            (t = n.Event("hide"), this.$element.trigger(t), this.isShown && !t.isDefaultPrevented()) && (this.isShown = !1, n("body").removeClass("modal-open"), f.call(this), this.$element.removeClass("in"), n.support.transition && this.$element.hasClass("fade") ? e.call(this) : i.call(this))
        }
    };
    ...
    n(function() {
        n("body").on("click.modal.data-api", '[data-toggle="modal"]', function(t) {
            var i = n(this),
                u, r = n(i.attr("data-target") || (u = i.attr("href")) && u.replace(/.*(?=#[^\s]+$)/, "")),
                f = r.data("modal") ? "toggle" : n.extend({}, r.data(), i.data());
            t.preventDefault();
            r.modal(f)
        })
    })
...
! function(n) {
    ...
    t.prototype = {
        ...
        init: function(t, i, r) {
            var u, f;
            if (this.type = t, this.$element = n(i), this.options = this.getOptions(r), this.enabled = !0, this.options.trigger != "manual") {
                u = this.options.trigger == "hover" ? "mouseenter" : "focus";
                f = this.options.trigger == "hover" ? "mouseleave" : "blur";
                this.$element.on(u, this.options.selector, n.proxy(this.enter, this));
                this.$element.on(f, this.options.selector, n.proxy(this.leave, this))
            }
        ...
        isHTML: function(n) {
            return typeof n != "string" || n.charAt(0) === "<" && n.charAt(n.length - 1) === ">" && n.length >= 3 || /^(?:[^<]*<[\w\W]+>[^>]*$)/.exec(n)
        },
        setContent: function() {
            var n = this.tip(),
                t = this.getTitle();
            n.find(".tooltip-inner")[this.isHTML(t) ? "html" : "text"](t);
        ...
        hide: function() {
            ...
            var r = this,
                t = this.tip();
            t.removeClass("in");
            n.support.transition && this.$tip.hasClass("fade") ? i() : t.remove()
        },
        fixTitle: function() {
            var n = this.$element;
    ...
    t.prototype = n.extend({}, n.fn.tooltip.Constructor.prototype, {
        ...
        setContent: function() {
            var n = this.tip(),
                t = this.getTitle(),
                i = this.getContent();
            n.find(".popover-title")[this.isHTML(t) ? "html" : "text"](t);
            n.find(".popover-content > *")[this.isHTML(i) ? "html" : "text"](i);
...
! function(n) {
    ...
    function t(t, i) {
        ...
        this.$scrollElement = f.on("scroll.scroll.data-api", u);
    ...
    t.prototype = {
        ...
        activate: function(t) {
            ...
            i.parent(".dropdown-menu") && (i = i.closest("li.dropdown").addClass("active"));
            i.trigger("activate")
        }
    };
...
! function(n) {
    ...
    t.prototype = {
        ...
        lookup: function() {
            var i = this,
                t;
            return (this.query = this.$element.val(), !this.query) ? this.shown ? this.hide() : this : (t = n.grep(this.source, function(n) {
                return i.matcher(n)
...
window.Modernizr = function(n, t, i) {
        ...
        var r = {},
            ...
            a = [],
            v = a.slice,
            s, k = function(n, i, r, e) {
                var l, a, c, v, o = t.createElement("div"),
                    h = t.body,
                    s = h || t.createElement("body");
                if (parseInt(r, 10))
                    while (r--) c = t.createElement("div"), c.id = e ? e[r] : f + (r + 1), o.appendChild(c);
            ...
            y = {}.hasOwnProperty,
            p, h;
        p = !e(y, "undefined") && !e(y.call, "undefined") ? function(n, t) {
            return y.call(n, t)
        } : function(n, t) {
        ...
        o.touch = function() {
            var i;
            return "ontouchstart" in n || n.DocumentTouch && t instanceof DocumentTouch ? i = !0 : k(["@media (", l.join("touch-enabled),("), f, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(n) {
                i = n.offsetTop === 9
            }), i
        };
        for (h in o) p(o, h) && (s = h.toLowerCase(), r[s] = o[h](), a.push((r[s] ? "" : "no-") + s));
        return r.addTest = function(n, t) {
            if (typeof n == "object")
                for (var f in n) p(n, f) && r.addTest(f, n[f]);
            else {
            ...
            return r
        }, w(""), b = g = null, r._version = "2.8.3", r._prefixes = l, r.testStyles = k, u.className = u.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (c ? " js " + a.join(" ") : ""), r
    }(this, this.document),
    function(n, t) {
        function c(n, t) {
        ...
        function l(n, i, u) {
            ...
            u || (u = f(i));
            var e;
            return e = u.cache[n] ? u.cache[n].cloneNode() : it.test(n) ? (u.cache[n] = u.createElem(n)).cloneNode() : u.createElem(n), e.canHaveChildren && !tt.test(n) && !e.tagUrn ? u.frag.appendChild(e) : e
        }
        ...
        function a(n) {
            n || (n = t);
            var u = f(n);
            return i.shivCSS && !s && !u.hasCSS && (u.hasCSS = !!c(n, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), r || b(n, u), n
        }
        ...
        var o = n.html5 || {},
            ...
            it = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,
            s, y = "_html5shiv",
            h = 0,
            p = {},
            r, i;
...
var prevID = 0,
    mnuHidden = 0,
    menuMouseTap = function() {
        $(".MenuBlockController ul li").on("mouseenter tap", function() {
            var r = $(this).attr("data-block-id"),
                t = $(this).position(),
                n = $(this).closest(".MenuBlockController"),
                u = n.attr("data-block-id").split("-")[0],
                i = 0;
            $(this).parent() !== null && $(this).parent().closest(".MenuBlockController").find("ul.level-1:first").length === 0 && (i = $(this).parent().width());
            $.ajax({
                method: "GET",
                url: "https://www.owens-minor.com/menublock/getsomething/" + u + "?parentP=" + r,
                success: function(r) {
                    n.find(".dynamic").css({
                        left: t.left + i + "px"
                    });
                    n.find(".dynamic").html(r);
                    n.find(".dynamic").show();
                    $(r).find(".level-2").length === 0 && n.find(".dynamic").css({
                        top: t.top + "px"
                    })
                }
            })
    ...
    menuClickTap = function() {
        $(".MenuBlockController ul li").on("click tap", function() {
            var t = $(this).attr("data-block-id"),
                i = $(this).position(),
                n = $(this).closest(".MenuBlockController"),
                r = n.attr("data-block-id").split("-")[0];
            $(this).closest(".dynamic").length === 0 && $(this).closest(".dynamic").css("display") === "block" ? $(this).closest(".dynamic").hide() : (mnuHidden = 0, $.ajax({
                method: "GET",
                url: "https://www.owens-minor.com/menublock/getsomething/" + r + "?parentP=" + t,
                success: function(t) {
                    $(window).width() > 750 ? n.find(".dynamic").css({
                        left: i.left + "px"
                    }) : n.find(".dynamic").css({
                        top: i.top + 53 + "px",
                        "background-color": "#c8c8c8"
                    });
                    n.find(".dynamic").html(t);
                    n.find(".dynamic").show()
                }
            }));
            prevID = t
    ...
    enableMenuMouseAction = function() {
        $(".MenuBlockController ul li").off("mouseenter click tap");
        $(window).width() > 750 ? menuMouseTap() : menuClickTap()
    };
$(document).ready(function() {
    var n = ".section-cards .card",
        t = 0,
        i = $(n).nextAll(),
        r = i.length + 1;
    $(n).each(function() {
    ...
    $(".MenuBlockController").mouseleave(function() {
        $(".dynamic").hide()
    })
});
! function(n) {
